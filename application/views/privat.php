...
<head>
    ...
    <title>Form Jadwal Pemeriksaan - Privat</title>
...
<body>
    <div class="container mt-4">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a id="privat" class="nav-link active text-white" href="#">Privat</a>
            </li>
            <li class="nav-item">
                <a id="bpjs" class="nav-link text-white" href="bpjs.html">BPJS</a>
            </li>
        </ul>
