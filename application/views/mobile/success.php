        ...
        <div class="modal-dialog d-flex align-items-center justify-content-center">
            <div class="modal-content text-center">
                <div class="modal-header bg-success">
                    <h1 id="title" class="modal-title fs-3 fw-medium text-center text-white" id="staticBackdropLabel">Success</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="fw-normal fs-5 text-center">Pemesanan jadwal pemeriksaan BPJS telah berhasil, silahkan catat kode berikut sebagai bukti anda telah mendaftar :</p>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog d-flex align-items-center justify-content-center">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="fw-normal fs-5 text-center">Nomor rujukan tidak ditemukan atau tidak valid</p>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-danger btn-lg" data-bs-dismiss="modal">Coba lagi</button>
                </div>
            </div>
        </div>
    </div>
